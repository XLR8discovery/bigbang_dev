...
import (
	...
	dockerfiles "xlr8d.io/bigbang-up/pkg/files/docker"
	"xlr8d.io/bigbang-up/pkg/files/templates"
)
...
func updateCompose(services []string, remoteType string) error {
	err := common.ExtractFile("", "bigbang.Dockerfile", dockerfiles.BigbangDocker)
	if err != nil {
		return err
	}
