...
import (
	...
	"xlr8d.io/bigbang/private/currency"
	"xlr8d.io/bigbang/satellite"
	"xlr8d.io/bigbang/satellite/accounting"
	"xlr8d.io/bigbang/satellite/buckets"
	"xlr8d.io/bigbang/satellite/compensation"
	"xlr8d.io/bigbang/satellite/nodeselection"
	"xlr8d.io/bigbang/satellite/satellitedb"
)
...
func projectUsageCmd() *cobra.Command {
	...
	projectUsageCmd.PersistentFlags().StringVarP(&email, "email", "e", "test@xlr8d.io", "the email address of the user to add data for")
